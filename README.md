<div align="center">
    ...
    - [wlm3201/Masonry_Image_Viewer](https://github.com/wlm3201/Masonry_Image_Viewer) - Masonry/Waterfall Image Viewer
    ...
    - [xiaoyou-bilibili/pi_camera_yolo](https://github.com/xiaoyou-bilibili/pi_camera_yolo) - 基于树莓派摄像头的YOLO实时检测
    ...
    - [vincentruan/wechat_autojump_game](https://github.com/vincentruan/wechat_autojump_game) - 用Golang实现微信跳一跳游戏自动玩
    ...
    - [YEreed/AV_Data_Capture](https://github.com/YEreed/AV_Data_Capture) - 本地电影刮削与整理一体化解决方案
    ...
    - [dearxuany/Sharon_Technology_learning_note](https://github.com/dearxuany/Sharon_Technology_learning_note) - Technology Learning Note Collection
    ...
    - [spring2go/engineer_competency_framework](https://github.com/spring2go/engineer_competency_framework) - 软件工程师职级胜任力框架(engineer level &amp; competency framework)
    ...
    - [zhangbincheng1997/picar_end2end](https://github.com/zhangbincheng1997/picar_end2end) - 使用 树莓派小车 + 深度学习 完成自动驾驶
    ...
    - [w0lfschild/cleanHUD](https://github.com/w0lfschild/cleanHUD) - :open_file_folder: MacForge Plugin that cleans up HUDs on macOS
    ...
    - [sensec/ddns-scripts_aliyun](https://github.com/sensec/ddns-scripts_aliyun) - OpenWrt/LEDE DDNS support for aliyun (阿里云)
    ...
    - [beansoft/visualgc_jdk8](https://github.com/beansoft/visualgc_jdk8) - The VisualGC 3.0 standalone version with enhancement for HotSpot JDK 8(独立运行版, 支持JDK 8, 增强了部分功能)
    ...
    - [Pi4J/pi4j-v2](https://github.com/Pi4J/pi4j-v2) - Pi4J Version 2.0
    ...
    - [newhoo/RestfulBox](https://github.com/newhoo/RestfulBox) - A powerful toolkit for restful services development.
    ...
    - [beansoft/visualgc_java8](https://github.com/beansoft/visualgc_java8) - Visualgc patch for Java 8+ and visualgc for IDEA
    ...
    - [Sayi/swagger-dubbo](https://github.com/Sayi/swagger-dubbo) - :page_with_curl: Dubbo的Swagger服务文档
    ...
    - [dong4j/spider_java](https://github.com/dong4j/spider_java) - 使用 jsoup api 实现的爬虫 写着玩儿的
    ...
    - [zhuangjiesen/WebSocket_Netty](https://github.com/zhuangjiesen/WebSocket_Netty) - netty实现的websocket推送框架
    ...
    - [baishui2004/common_gui_tools](https://github.com/baishui2004/common_gui_tools) - Common Gui Tools 是用java编写，GUI界面的实用小工具集，1.5版分六个类别22个小工具。
    ...
    - [hellokaton/swing-generate](https://github.com/hellokaton/swing-generate) - :speak_no_evil: Swing development code generator
    ...
    - [crossoverJie/springboot-cloud](https://github.com/crossoverJie/springboot-cloud) - :two_men_holding_hands: springboot + springcloud build micro service
    ...
    - [dong4j/dubbo_demo](https://github.com/dong4j/dubbo_demo) - zookeeper+dubbo+ssm 例子
    ...
    - [ogromwang/xhz_app](https://github.com/ogromwang/xhz_app) - 📱 xhz 一个基于 Flutter Go 的在线亲友记账共享 app
    ...
    - [YiiGuxing/intellij-figlet](https://github.com/YiiGuxing/intellij-figlet) - :electric_plug:A FIGlet-based ASCII Art generation plugin for IntelliJ based IDEs.
